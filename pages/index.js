    ...
    <>
      ...
      <main className="app__main">
        ...
        <section className="app__services">
          <div className="container">
            <section className="app__services-info">
              <h3 className="app__services-title">Why choose Easybank?</h3>
              <p className="app__services-description">
                We leverage Open Banking to turn your bank account into your
                financial hub. Control your finances like never before.
              </p>
            </section>
            <section className="app__services-container">
      ...
      <footer className="app__footer">
        <section className="app__footer-icons">
          <svg
          ...
          >
            ...
            <g fill="none" fillRule="evenodd">
              <path
                className="app__logo--footer-text"
                fill="#2D314D"
                fillRule="nonzero"
        ...
        <nav className="app__navigation app__navigation--secondary">
          <a className="app__link" href="#">
            About Us
          </a>
          <a className="app__link" href="#">
        ...
        <section className="app__footer-button">
          <CTAButton text="Request Invite" />
          <p className="app__copyrights">© Easybank. All Rights Reserved</p>
        </section>
      </footer>
    </>
  );
